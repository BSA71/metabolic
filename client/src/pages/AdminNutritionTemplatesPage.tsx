...
import { CloneDailyLogDialog } from '../components/admin/CloneDailyLogDialog';
    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <h1 className="mt-2 text-3xl font-bold">Nutrition Templates</h1>
          <p className="text-slate-500">Create and manage full-day nutrition plan templates.</p>
        </div>
              ...
              <tbody>
                {templates.map((template) => (
                  <tr key={template.id} className="border-b border-slate-100 last:border-0">
                    ...
                    <td className="py-3 pr-4 text-slate-600">{formatMacros(template)}</td>
